...
library(readxl)
setwd("~/Desktop/PGx-Guidelines-Fig-main")
...
dfall <- data.frame(read_excel("data/PGx_GuideLine_Figures_data.xlsx", sheet="Figure-A"))
...
#plt
##8.27 × 11.69 inches
#png("figures/fig-1.png", width = 8, height = 3.0, units = "in" ,res = 600)
#print(plt)
#dev.off()
##-----------------------------------------
...
##8.27 × 11.69 inches
png("figures/fig-s1.png", width = 8, height = 4.50, units = "in", res = 600)
print(spearmanPlot)
dev.off()
